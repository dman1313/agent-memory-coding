2026-06-11T00:30:00Z | MacH | note | last30days-skill | Cloned mvanhorn/last30days-skill v3.3.2 to ~/last30days-skill. Symlinked to ~/.hermes/skills/research/last30days for live-edit. Installed Python 3.12 (brew) and yt-dlp. Free sources (reddit, hackernews, polymarket, github) work; X/Twitter/YouTube/TikTok/Instagram need API keys or browser cookies. Diagnose run confirmed all free sources available. Notified fleet in AGENT-CHANNEL.
